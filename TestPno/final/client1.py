...
# Set the year to 2022
        ...
        if template == 'true':
            ...
            if button5 == True:
                rad4 = [0,0,0,0]
                rad1 = [random.uniform(10,30) for _ in range(8)]
                rad5 = [random.uniform(5,15) for _ in range(4)]
                rad2 = [0,0,0,0,0,0,0,0]
                rad = rad4+rad1 + rad5 + rad2 
            if button4 == True:
                rad4 = [0,0,0,0]
                rad1 = [random.uniform(50,100) for _ in range(8)]
                rad5 = [random.uniform(10,30) for _ in range(4)]
                rad2 = [5,2,0,0,0,0,0,0]
                rad = rad4+rad1 + rad5 + rad2 
            if button3 == True:
                rad4 = [0,0,7,15]
                rad1 = [random.uniform(200,300) for _ in range(8)]
                rad5 = [random.uniform(90,150) for _ in range(4)]
                rad2 = [100,60,10,5,0,0,0,0]
                rad = rad4+rad1 + rad5 + rad2 
        if button1 == True:
...
def pagina3():
    wpbooleanforserver = []
    aircobooleanforserver = []
    autobooleanforserver = []
    wasmachinebooleanforserver = []
    keukenbooleanforserver = []
    for x in verbruikwarmtepomp:
        if x > 0:
            wpbooleanforserver.append(1)
        else:
            wpbooleanforserver.append(0)
    for x in verbruikeAirco:
        if x > 0:
            aircobooleanforserver.append(1)
        else:
            aircobooleanforserver.append(0)
    for x in auto:
        if x > 0:
            autobooleanforserver.append(1)
        else:
            autobooleanforserver.append(0)
    for x in wasmachine:
        if x > 0:
            wasmachinebooleanforserver.append(1)
        else:
            wasmachinebooleanforserver.append(0)
    for x in keuken_verbruik:
        if x > 0:
            keukenbooleanforserver.append(1)
        else:
            keukenbooleanforserver.append(0)
    autobooleanforserver = [str(num) for num in autobooleanforserver if isinstance(num, int)]
    autobooleanforserver = ''.join(autobooleanforserver)
    wasmachinebooleanforserver = [str(num) for num in wasmachinebooleanforserver if isinstance(num, int)]
    wasmachinebooleanforserver = ''.join(wasmachinebooleanforserver)
    keukenbooleanforserver = [str(num) for num in keukenbooleanforserver if isinstance(num, int)]
    keukenbooleanforserver = ''.join(keukenbooleanforserver)
    wpbooleanforserver = [str(num) for num in wpbooleanforserver if isinstance(num, int)]
